...
"""
function attach(var::Value, varPtrPtr=nothing::Union{Nothing, Value}; bounds::Vector{Value}, asyncOperands::Vector{Value}, accVar::IR.Type, varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
...
using the activity queues on these devices as defined by the async values.
"""
function cache(var::Value, varPtrPtr=nothing::Union{Nothing, Value}; bounds::Vector{Value}, asyncOperands::Vector{Value}, accVar::IR.Type, varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[accVar, ]
    operands = Value[var, bounds..., asyncOperands..., ]
    owned_regions = Region[]
    successors = Block[]
...
using the activity queues on these devices as defined by the async values.
"""
function copyin(var::Value, varPtrPtr=nothing::Union{Nothing, Value}; bounds::Vector{Value}, asyncOperands::Vector{Value}, accVar::IR.Type, varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[accVar, ]
    operands = Value[var, bounds..., asyncOperands..., ]
    owned_regions = Region[]
    successors = Block[]
...
- `varPtr`: The address of variable to copy back to.
    ...
    using the activity queues on these devices as defined by the async values.
"""
function copyout(accVar::Value, var::Value, bounds::Vector{Value}, asyncOperands::Vector{Value}; varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[]
...
using the activity queues on these devices as defined by the async values.
"""
function create(var::Value, varPtrPtr=nothing::Union{Nothing, Value}; bounds::Vector{Value}, asyncOperands::Vector{Value}, accVar::IR.Type, varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[accVar, ]
    operands = Value[var, bounds..., asyncOperands..., ]
    owned_regions = Region[]
    successors = Block[]
...
using the activity queues on these devices as defined by the async values.
"""
function declare_device_resident(var::Value, varPtrPtr=nothing::Union{Nothing, Value}; bounds::Vector{Value}, asyncOperands::Vector{Value}, accVar::IR.Type, varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[accVar, ]
    operands = Value[var, bounds..., asyncOperands..., ]
    owned_regions = Region[]
    successors = Block[]
...
using the activity queues on these devices as defined by the async values.
"""
function declare_link(var::Value, varPtrPtr=nothing::Union{Nothing, Value}; bounds::Vector{Value}, asyncOperands::Vector{Value}, accVar::IR.Type, varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[accVar, ]
    operands = Value[var, bounds..., asyncOperands..., ]
    owned_regions = Region[]
    successors = Block[]
...
using the activity queues on these devices as defined by the async values.
"""
function delete(accVar::Value, bounds::Vector{Value}, asyncOperands::Vector{Value}; asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[]
...
using the activity queues on these devices as defined by the async values.
"""
function detach(accVar::Value, bounds::Vector{Value}, asyncOperands::Vector{Value}; asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[]
    operands = Value[accVar, bounds..., asyncOperands..., ]
    owned_regions = Region[]
    successors = Block[]
...
using the activity queues on these devices as defined by the async values.
"""
function deviceptr(var::Value, varPtrPtr=nothing::Union{Nothing, Value}; bounds::Vector{Value}, asyncOperands::Vector{Value}, accVar::IR.Type, varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[accVar, ]
    operands = Value[var, bounds..., asyncOperands..., ]
    owned_regions = Region[]
    successors = Block[]
...
using the activity queues on these devices as defined by the async values.
"""
function firstprivate(var::Value, varPtrPtr=nothing::Union{Nothing, Value}; bounds::Vector{Value}, asyncOperands::Vector{Value}, accVar::IR.Type, varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[accVar, ]
    operands = Value[var, bounds..., asyncOperands..., ]
    owned_regions = Region[]
    successors = Block[]
...
\\
    ...
    using the activity queues on these devices as defined by the async values.
"""
function getdeviceptr(var::Value, varPtrPtr=nothing::Union{Nothing, Value}; bounds::Vector{Value}, asyncOperands::Vector{Value}, accVar::IR.Type, varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[accVar, ]
    operands = Value[var, bounds..., asyncOperands..., ]
    owned_regions = Region[]
    successors = Block[]
...
using the activity queues on these devices as defined by the async values.
"""
function nocreate(var::Value, varPtrPtr=nothing::Union{Nothing, Value}; bounds::Vector{Value}, asyncOperands::Vector{Value}, accVar::IR.Type, varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[accVar, ]
    operands = Value[var, bounds..., asyncOperands..., ]
    owned_regions = Region[]
    successors = Block[]
...
using the activity queues on these devices as defined by the async values.
"""
function present(var::Value, varPtrPtr=nothing::Union{Nothing, Value}; bounds::Vector{Value}, asyncOperands::Vector{Value}, accVar::IR.Type, varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[accVar, ]
    operands = Value[var, bounds..., asyncOperands..., ]
    owned_regions = Region[]
    successors = Block[]
...
using the activity queues on these devices as defined by the async values.
"""
function private(var::Value, varPtrPtr=nothing::Union{Nothing, Value}; bounds::Vector{Value}, asyncOperands::Vector{Value}, accVar::IR.Type, varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[accVar, ]
    operands = Value[var, bounds..., asyncOperands..., ]
    owned_regions = Region[]
    successors = Block[]
...
using the activity queues on these devices as defined by the async values.
"""
function reduction(var::Value, varPtrPtr=nothing::Union{Nothing, Value}; bounds::Vector{Value}, asyncOperands::Vector{Value}, accVar::IR.Type, varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[accVar, ]
    operands = Value[var, bounds..., asyncOperands..., ]
    owned_regions = Region[]
    successors = Block[]
...
using the activity queues on these devices as defined by the async values.
"""
function update_device(var::Value, varPtrPtr=nothing::Union{Nothing, Value}; bounds::Vector{Value}, asyncOperands::Vector{Value}, accVar::IR.Type, varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[accVar, ]
    operands = Value[var, bounds..., asyncOperands..., ]
    owned_regions = Region[]
    successors = Block[]
...
- `varPtr`: The address of variable to copy back to.
    ...
    using the activity queues on these devices as defined by the async values.
"""
function update_host(accVar::Value, var::Value, bounds::Vector{Value}, asyncOperands::Vector{Value}; varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[]
    operands = Value[accVar, var, bounds..., asyncOperands..., ]
    owned_regions = Region[]
    successors = Block[]
...
using the activity queues on these devices as defined by the async values.
"""
function use_device(var::Value, varPtrPtr=nothing::Union{Nothing, Value}; bounds::Vector{Value}, asyncOperands::Vector{Value}, accVar::IR.Type, varType, asyncOperandsDeviceType=nothing, asyncOnly=nothing, dataClause=nothing, structured=nothing, implicit=nothing, name=nothing, location=Location())
    op_ty_results = IR.Type[accVar, ]
    operands = Value[var, bounds..., asyncOperands..., ]
    owned_regions = Region[]
    successors = Block[]
