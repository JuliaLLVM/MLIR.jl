...
"""
function winograd_filter_transform(filter::Value, output::Value; result::IR.Type, m, r, location=Location())
    op_ty_results = IR.Type[result, ]
...
"""
function winograd_input_transform(input::Value, output::Value; result::IR.Type, m, r, location=Location())
    op_ty_results = IR.Type[result, ]
    operands = Value[input, output, ]
    owned_regions = Region[]
    successors = Block[]
...
"""
function winograd_output_transform(value::Value, output::Value; result::IR.Type, m, r, location=Location())
    op_ty_results = IR.Type[result, ]
