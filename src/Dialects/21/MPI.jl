...
to check for errors.
"""
function allreduce(sendbuf::Value, recvbuf::Value, comm::Value; retval=nothing::Union{Nothing, IR.Type}, op, location=Location())
...
to check for errors.
"""
function comm_rank(comm::Value; retval=nothing::Union{Nothing, IR.Type}, rank::IR.Type, location=Location())
...
to check for errors.
"""
function comm_size(comm::Value; retval=nothing::Union{Nothing, IR.Type}, size::IR.Type, location=Location())
...
to check for errors.
"""
function comm_split(comm::Value, color::Value, key::Value; retval=nothing::Union{Nothing, IR.Type}, newcomm::IR.Type, location=Location())
...
to check for errors.
"""
function irecv(ref::Value, tag::Value, source::Value, comm::Value; retval=nothing::Union{Nothing, IR.Type}, req::IR.Type, location=Location())
...
to check for errors.
"""
function isend(ref::Value, tag::Value, dest::Value, comm::Value; retval=nothing::Union{Nothing, IR.Type}, req::IR.Type, location=Location())
    op_ty_results = IR.Type[req, ]
...
to check for errors.
"""
function recv(ref::Value, tag::Value, source::Value, comm::Value; retval=nothing::Union{Nothing, IR.Type}, location=Location())
    op_ty_results = IR.Type[]
    operands = Value[ref, tag, source, comm, ]
    owned_regions = Region[]
    successors = Block[]
...
to check for errors.
"""
function send(ref::Value, tag::Value, dest::Value, comm::Value; retval=nothing::Union{Nothing, IR.Type}, location=Location())
    op_ty_results = IR.Type[]
    operands = Value[ref, tag, dest, comm, ]
    owned_regions = Region[]
    successors = Block[]
