...
```
"""
function call_indirect(callee::Value, callee_operands::Vector{Value}; results::Vector{IR.Type}, arg_attrs=nothing, res_attrs=nothing, location=Location())
...
```
"""
function call(operands::Vector{Value}; result_0::Vector{IR.Type}, callee, arg_attrs=nothing, res_attrs=nothing, no_inline=nothing, location=Location())
...
```
"""
function func_(; sym_name, function_type, sym_visibility=nothing, arg_attrs=nothing, res_attrs=nothing, no_inline=nothing, body::Region, location=Location())
