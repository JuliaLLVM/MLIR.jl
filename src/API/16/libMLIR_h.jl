...
function mlirPassManagerRun(passManager, _module)
    @ccall (mlir_c).mlirPassManagerRun(
...
function mlirSparseTensorEncodingGetNumDimLevelTypes(attr)
    @ccall (mlir_c).mlirSparseTensorEncodingGetNumDimLevelTypes(
        attr::MlirAttribute
    )::Cptrdiff_t
end
...
function mlirSparseTensorEncodingAttrGetDimLevelType(attr, pos)
    @ccall (mlir_c).mlirSparseTensorEncodingAttrGetDimLevelType(
        attr::MlirAttribute, pos::Cptrdiff_t
    )::MlirSparseTensorDimLevelType
end
...
function mlirSparseTensorEncodingAttrGetDimOrdering(attr)
    @ccall (mlir_c).mlirSparseTensorEncodingAttrGetDimOrdering(
        attr::MlirAttribute
    )::MlirAffineMap
end
...
function mlirSparseTensorEncodingAttrGetHigherOrdering(attr)
    @ccall (mlir_c).mlirSparseTensorEncodingAttrGetHigherOrdering(
        attr::MlirAttribute
    )::MlirAffineMap
end
...
function mlirSparseTensorEncodingAttrGetPointerBitWidth(attr)
    @ccall (mlir_c).mlirSparseTensorEncodingAttrGetPointerBitWidth(
        attr::MlirAttribute
    )::Cint
end
...
function mlirSparseTensorEncodingAttrGetIndexBitWidth(attr)
    @ccall (mlir_c).mlirSparseTensorEncodingAttrGetIndexBitWidth(
        attr::MlirAttribute
    )::Cint
end
